    ...
    <div className="relative flex items-center w-max font-sans drop-shadow-sm">
      ...
      <div className="relative flex items-center h-[76px] pl-10 pr-14 -mr-10 z-0">
        <svg
          ...
          className="absolute inset-0 w-full h-full text-[#BEE9FB]"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M 200 0 L 200 100 L 8 92 Q 0 91 0 82 L 0 18 Q 0 9 8 8 Z" />
        </svg>
        <span className="relative z-10 text-[#FF5511] text-[32px] font-black tracking-wide">
          YOU
        </span>
      </div>

      {/* Right Scalloped Badge */}
      <div className="relative w-[116px] h-[116px] z-10 flex items-center justify-center">
        <svg
          viewBox="0 0 100 100"
          className="absolute inset-0 w-full h-full text-[#2998E5]"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <div className="relative w-[78px] h-[78px] rounded-full overflow-hidden bg-[#F5F5F5] z-20 shadow-inner flex items-center justify-center">
          <AutoPlayVideo
            src="/videos/delivery-box.mp4"
